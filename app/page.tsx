...
import { Brain, Globe, Shield, Sparkles, Star, Users, Zap } from 'lucide-react'
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900">
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="absolute top-0 left-1/2 w-[800px] h-[800px] bg-gradient-to-r from-blue-400/20 via-purple-500/20 to-pink-500/20 rounded-full blur-3xl -translate-x-1/2 -translate-y-1/2 floating" />
       ...
       <div className="py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-transparent to-gray-50/50 dark:to-gray-800/50">
         <div className="mx-auto max-w-4xl text-center">
           <h2 className="text-4xl font-bold text-gray-900 dark:text-white mb-6">
             Ready to Experience the Future?
           </h2>
           <p className="text-xl text-gray-600 dark:text-gray-300 mb-8 max-w-2xl mx-auto">
             Join millions of users who are already experiencing the power of next-generation artificial intelligence.
           </p>
