...
export function Chat({
  ...
  return (
    <div className="flex flex-col w-full max-w-6xl mx-auto min-h-[calc(100vh-8rem)]">
      {/* Header Section */}
      <div className="mb-8">
      ...
      {/* Chat Panel */}
      <div className="sticky bottom-0 bg-background/80 backdrop-blur-xl border-t border-border/50 pb-6"> {/* Increased bottom padding */}
        <ChatPanel
          input={input}
